          ...
          <View style={styles.headerContainer}>
            ...
            <View style={styles.headerDetails}>
              ...
              <Text style={styles.headerDetail}>
                Type: {event.type === "collection" ? "Collection Event" : "Distribution Event"}
              </Text>
            ...
            <>
              ...
              <View style={styles.table}>
                ...
                {records.map((record, index) => {
                  ...
                  const paidTime = record.updatedAt
                    ? new Date((record.updatedAt as { seconds: number; nanoseconds: number }).seconds * 1000).toLocaleTimeString()
                    : "-";
                  return (
