...
import { Container, Typography, Box, Button, IconButton, Grid, Skeleton, Stack, Fade } from '@mui/material';
                    ...
                    <Grid item xs={12} md={8}>
                      <Stack spacing={3}>
                        <AnimatedContainer animation="fade" delay={0.2}>
                          <HouseholdInformationDetails family={family!} handleUpdate={handleUpdate} isUpdating={updating} />
                        </AnimatedContainer>
                        
                        <AnimatedContainer animation="fade" delay={0.3}>
                          <HeadOfFamilyDetails family={family!} handleUpdate={handleUpdate} isUpdating={updating} />
                        </AnimatedContainer>
                        
                        <AnimatedContainer animation="fade" delay={0.4}>
                          <SpouseDetails family={family!} handleUpdate={handleUpdate} isUpdating={updating} />
                        </AnimatedContainer>
                        
                        <AnimatedContainer animation="fade" delay={0.5}>
                          <ChildrenDetails family={family!} handleUpdate={handleUpdate} isUpdating={updating} />
                        </AnimatedContainer>
                        
                        <AnimatedContainer animation="fade" delay={0.6}>
                          <OtherMembersDetails family={family!} handleUpdate={handleUpdate} isUpdating={updating} />
                        </AnimatedContainer>
                      </Stack>
                    </Grid>
                    <Grid item xs={12} md={4}>
